...
```{r setup-visualization, message=FALSE, warning=FALSE, echo=FALSE}
...
```{r echo = FALSE}
mytable <- rbind(c(5,15,30,3), c(10,37,21,29), c(1,40,0,14))
rownames(mytable) <- c("treatment 1","treatment 2", "treatment 3")
colnames(mytable) <- c("round", "spiky", "stretched", "flat")
knitr::kable(mytable, align="cccc")
```
...
colnames(table1) <- c("round","stretched")
rownames(table1) <- c("ctrl", "trt")
knitr::kable(table1, align="cccc")
```
...
colnames(table2) <- c("round","stretched")
rownames(table2) <- c("ctrl", "trt")
table3 <- rbind(c(7, 40), c(22,41))
colnames(table3) <- c("round","stretched")
rownames(table3) <- c("ctrl", "trt")

table3d <- array(c(table1, table2, table3), dim = c(2,2,3))
knitr::kable(list(table1, table2, table3), align="cc")
```
...
```{r echo=FALSE}
knitr::kable(table1, align="cc", caption="replicate 1")
knitr::kable(table2, align="cc", caption="replicate 2")
knitr::kable(table3, align="cc", caption="replicate 3")
```
